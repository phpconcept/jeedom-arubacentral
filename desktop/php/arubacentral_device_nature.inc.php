...
?>
  ...
  <div class="row form-group">
    <label class="col-sm-4 control-label">{{Typde de Device :}}</label>
    <div class="col-sm-8">

      <select id="ac_device_type" class="cp_attr_device eqLogicAttr form-control" data-l1key="configuration" data-l2key="device_type">
          <?php
            foreach (arubacentral::acDeviceTypeList(false) as $v_id=>$v_item) {
